<section class="max-w-7xl mx-auto px-4 py-16 md:py-24">
    <div class="grid md:grid-cols-2 gap-12 items-start">
        ...
        <!-- LEFT -->
        <div>
            <p class="text-xs font-semibold tracking-[0.24em] uppercase text-ui-subtext mb-4">
                For people who take learning seriously
            </p>

            <h2 class="text-4xl md:text-5xl font-bold text-ui-text leading-tight mb-6">
            ...
            <p class="text-sm text-ui-subtext leading-relaxed max-w-xl">
                No noise. No filler. Just the sharpest thinking, distilled for real life and real decisions.
            </p>
        </div>
